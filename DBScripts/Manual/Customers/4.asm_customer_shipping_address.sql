DROP TABLE IF EXISTS asm_customer_shipping_address;
CREATE TABLE asm_customer_shipping_address (
  ...
  CONSTRAINT asm_customer_shipping_address_pk PRIMARY KEY (`id`),
  CONSTRAINT asm_customer_shipping_address_customer_id_fk FOREIGN KEY (customer_id) REFERENCES asm_customers (`customer_id`)
) ;